...
from backend.sales.app.schemas.calendar_task import CalendarTaskCreate, CalendarTaskUpdate, CalendarTaskResponse
from backend.sales.app.services.calendar_task_service import CalendarTaskService
...
def delete_task(task_id: UUID, user_id: UUID = Depends(get_current_user_id), db: Session = Depends(get_db)):
