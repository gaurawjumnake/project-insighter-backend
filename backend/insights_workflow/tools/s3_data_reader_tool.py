...
class S3DataReaderTool(BaseTool):
    ...
    description: str = (
        ...
        "Supports reading project, account, and private_equity data with entity-aware file naming. "
        ...
        try:
            ...
            if return_as == "local_path":
                ...
                if filename.startswith("account_"):
                    ...
                    entity_type = "project"
                elif filename.startswith("private_equity_") or filename.startswith("pe_"):
                    entity_type = "private_equity"
                else:
                    entity_type = data.get("metadata", {}).get("entity_type", "unknown")
