...
from backend.finance.doc_processor.services.code_quality import process_code_quality_document, get_project_document
...
async def import_code_quality_document(
    ...
    try:
        ...
        def wrapper_function(db, file_path, account_id, dry_run):
            return process_code_quality_document(
                db=db, 
                file_path=file_path, 
