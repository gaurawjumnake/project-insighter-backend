...
from backend.finance.doc_processor.services.best_practices import process_best_practices_document, get_project_document
...
async def import_best_practices_document(
    ...
    try:
        ...
        def wrapper_function(db, file_path, account_id, dry_run):
            return process_best_practices_document(
                db=db, 
                file_path=file_path, 
